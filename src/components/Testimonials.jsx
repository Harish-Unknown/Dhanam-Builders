            ...
            <section className="pb-22 text-center w-full">
                ...
                <div data-aos="fade-up" className="grid gap-x-8 md:grid-cols-3 lg:gap-x-12">
                    <div className="mb-12 md:mb-0 border-2 p-3 rounded-xl bg-[#f1e7ec] transition duration-500 transform hover:bg-[#e4e1e3] hover:scale-[1.03]">
                        ...
                        <h5 className="mb-2 text-lg font-bold">Srikanth</h5>
                        {/* <h6 className="mb-4 font-medium text-white">
                            Full Stack Developer
                        </h6> */}
                        <p className="mb-4 px-3">
                            Dhanam Builders did a great job building our home. They finished it on time and didn't go over budget. We're happy with their work.
                    ...
                    <div className="mb-12 md:mb-0 border-2 p-3 rounded-xl bg-[#f1e7ec] transition duration-500 transform hover:bg-[#e4e1e3] hover:scale-[1.03]">
                        {/* <div className="mb-6 flex justify-center">
                            <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(8).jpg"
                                className="w-32 rounded-full shadow-lg" />
                        </div> */}
                        <h5 className="mb-2 text-lg font-bold">Krishnan</h5>
                        {/* <h6 className="mb-4 font-medium text-white">
                            App Developer
                        </h6> */}
                        <p className="mb-4 px-3">
                            Dhanam Builders did a great job. They were good at what they did and kept us informed throughout the process.
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" className="inline-block w-6">
                                <path fill="currentColor"
                                    d="M580 556h160V396H580v160Zm-360 0h160V396H220v160Zm406 220 80-160H520V336h280v288l-76 152h-98Zm-360 0 80-160H160V336h280v288l-76 152h-98Zm34-300Zm360 0Z" />
                            </svg>
                    ...
                    <div className="mb-0 border-2 p-3 rounded-xl bg-[#f1e7ec] transition duration-500 transform hover:bg-[#e4e1e3] hover:scale-[1.03]">
                        {/* <div className="mb-6 flex justify-center">
                            <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(9).jpg"
                                className="w-32 rounded-full shadow-lg" />
                        </div> */}
                        <h5 className="mb-2 text-lg font-bold">Jayanthi</h5>
                        {/* <h6 className="mb-4 font-medium text-white">
                            Web Developer
                        </h6> */}
                        <p className="mb-4 px-3">
                            We're really happy with Dhanam Builders. They built our house well and were good at communicating with us.
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" className="inline-block w-6">
                                <path fill="currentColor"
                                    d="M580 556h160V396H580v160Zm-360 0h160V396H220v160Zm406 220 80-160H520V336h280v288l-76 152h-98Zm-360 0 80-160H160V336h280v288l-76 152h-98Zm34-300Zm360 0Z" />
                            </svg>
